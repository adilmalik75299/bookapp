...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container z-50 bg-white mx-auto dark:bg-slate-900 dark:text-white md:px-20 px-4 fixed top-0 left-0 right-0
        ${
          sticky
          ...
          <div className="navbar-end space-x-3">
            ...
            {authUser  ? (
              ...
              <div className="">
                <a
                  onClick={handleLogin} 
                  className="bg-black text-white px-3 py-2 cursor-pointer rounded-md hover:bg-slate-500 duration-300"
                >
                  Login
                </a>
                <Login />
